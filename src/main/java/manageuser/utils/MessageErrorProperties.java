 ...
 * MessageErrorProperties.java,HuyNQ
...
/**
 * class dung de doc cac thong bao loi duoc luu trong message_error_ja.properties
 * @author HuyNQ
 *
 */
		...
		static {
			try {
				...
				properties.load(new InputStreamReader(
						DatabaseProperties.class.getClassLoader().getResourceAsStream(Constant.PROPERTIES_MESSAGE_ERROR_PATH), "UTF-8"));
